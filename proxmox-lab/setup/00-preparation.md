...
| **1G (QDevice)** | Dell Pro 14 onboard NIC, or a USB-C adapter → same router / switch | 192.168.0.10 /24, gw 192.168.0.1 | Third corosync vote (qnetd). Wired only — never Wi-Fi ([8.1](../cluster/08-qdevice.md#81-the-box-and-its-os)) |
...
| ④ | QDevice — **onboard** 1G RJ45 (or a USB-C adapter) | Existing router / home switch | Cat5e or better | Third corosync vote (qnetd), at static `192.168.0.10` ([8.1](../cluster/08-qdevice.md#81-the-box-and-its-os)) |
...
- **Paper copy:** the break-glass private key and its passphrase, alongside the two other things that are unrecoverable rather than merely inconvenient — the rclone crypt passwords ([17.3](../backup/17-backup-restore.md#173-offsite--digi-storage)) and the VM `--cipassword` ([21.4](../operations/21-credentials.md#214-the-console-is-the-final-safety-net--give-it-a-password)).
