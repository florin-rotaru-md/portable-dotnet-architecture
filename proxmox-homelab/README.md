...
- **Building from zero:** setup → cluster → vms → ha → backup, in stage order. Stages 0–12 are a weekend; 14 and the test plan in 15.6 before going live are not optional.
...
- **Something looks wrong:** [health checks](ha/15-failover.md#157-health-checks-worth-running-periodically), then [troubleshooting](troubleshooting.md).
