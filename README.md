...
For a self-hosted **two-node Proxmox cluster** running the `native/` runtime model with ZFS replication, HA, live migration and a full backup/recovery story, see [`proxmox-homelab/`](proxmox-homelab/) — a complete build-and-operate guide.
